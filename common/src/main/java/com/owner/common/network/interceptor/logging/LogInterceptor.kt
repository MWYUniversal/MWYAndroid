...
import com.owner.common.util.UrlEncoderUtils.Companion.hasUrlEncoded
import com.owner.common.util.ZipHelper.Companion.decompressForGzip
import com.owner.common.util.ZipHelper.Companion.decompressToStringForZlib
import okhttp3.*
import okio.Buffer
    ...
    companion object {
        ...
        fun isPlain(mediaType: MediaType?): Boolean {
            return if (mediaType?.subtype == null) {
                false
            } else mediaType.subtype.lowercase().contains("plain")
        }
