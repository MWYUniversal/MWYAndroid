package com.owner.recycler_view.view.home.adapter
...
import com.owner.recycler_view.databinding.DefSectionHeadBinding
import com.owner.recycler_view.databinding.HomeItemViewBinding
...
class HomeAdapter(data: MutableList<HomeEntity>) : BaseMultiItemAdapter<HomeEntity>(data) {
    ...
    class HeaderVH(val viewBinding: DefSectionHeadBinding) :
